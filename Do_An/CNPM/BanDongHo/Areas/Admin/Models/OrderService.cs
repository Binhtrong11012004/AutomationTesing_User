...
namespace BanDongHo.Areas.Admin.Models
{
    public class OrderService
    {
        ...
        public IEnumerable<DONHANG> getAllOrder()// Phương thức trả về một IEnumerable của các đối tượng kiểu DONHANG using duyệt vòng foreach
        {          
        ...
        public List<SANPHAM> LoadAllProduct()//List Sp
        {
